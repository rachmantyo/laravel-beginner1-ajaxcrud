...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <?php echo $__env->make('contact_ajax/form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <script type="text/javascript">
      var tabel = $('#contact-table').DataTable({
                  processing: true,
                  serverSide: true,
      ...
      //   var popup = confirm("Are You sure to delete it ?");
